...
Drupal.behaviors.rubik = function(context) {
  ...
  // Fixes the problem of Panels hiding (display: none;) its "Display settings"
  // when using "No title" or "From pane". First bit changes it on page load.
  $('div#ctools-dropdown-1').parent().css('display', 'block');
  // Second bit changes it when a change is made from the select element dropdown.
  $("#edit-display-title-hide-title").change(function() {
    $('div#ctools-dropdown-1').parent().css('display', 'block');
  });
};
