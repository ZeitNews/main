<?php
// $Id: imce-content.tpl.php,v 1.9.2.3 2010/10/06 04:38:09 ufku Exp $
...
<div id="help-box"><!-- Update help content if you disable any of the extra features above. -->
  <div id="help-box-title"><span><?php print t('READ NOW'); ?>!</span></div>
  <div id="help-box-content">
    <h4><?php print t('Important'); ?>:</h4>
    <ul class="tips">
      <li><?php print t('<em><strong>DO NOT RENAME OR DELETE ANYTHING, unless you know what you\'re doing</strong>. It\'s very easy to break things in here. Be careful!</em>'); ?></li>
      <li><?php print t('<em><strong>Do not rename directories you didn\'t create</strong>. If you rename directories created by the system, you will break all your nodes.</em>'); ?></li>
      <li><?php print t('<em><strong>Rename images BEFORE inserting them</strong>. If you rename an image already in use, it will disappear from the node. You then must fix its URL in the node body.</em>'); ?></li>
      <li><?php print t('<em><strong>Having trouble cropping a large image?</strong> Resize it first using one of the "Presets" and crop on. You can also maximize/fullscreen your window.</em>'); ?></li>
    </ul>
    <br/>
