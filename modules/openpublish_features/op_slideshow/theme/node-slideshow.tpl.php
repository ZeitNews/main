<?php
// $Id: node-slideshow.tpl.php,v 1.1.2.10 2010/10/26 21:17:19 jec006 Exp $
/**
 * @file
 * Template for slideshow content type.
 * 
 * Available variables:
 * - $type: Content type (slideshow).
 * - $field_deck: Used to determine visibility of $field_deck_value.
 * - $field_deck_value: The slideshow's deck text.
 * - $authors: List of authors.
 * - $node_created: The slideshow's post date.
 * - $node_created_timestamp: The slideshow's post date in timestamp format.
 * - $body: Actual body content of the slideshow.
 * - $main_image: The slideshow's main image.
...
<div class="section-date-author">
	<?php print l(t($type), 'multimedia', array('query' => 'type[]=slideshow')); ?> | 
